/* src/libsecp256k1-config.h.  Generated from libsecp256k1-config.h.in by configure.  */
 ...
 /* Name of package */
 #define PACKAGE "libsecp256k1vb"
 
 /* Define to the address where bug reports for this package should be sent. */
 #define PACKAGE_BUGREPORT ""
 
 /* Define to the full name of this package. */
 #define PACKAGE_NAME "libsecp256k1vb"
 
 /* Define to the full name and version of this package. */
 #define PACKAGE_STRING "libsecp256k1vb 0.1"
 
 /* Define to the one symbol short name of this package. */
 #define PACKAGE_TARNAME "libsecp256k1vb"
 ...
 /* #undef USE_ECMULT_STATIC_PRECOMPUTATION 1 */
