 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_xonly_pubkey_parse(
 ...
 */
SECP256K1_API int SECP256_CC secp256k1_xonly_pubkey_serialize(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_xonly_pubkey_from_pubkey(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_xonly_pubkey_tweak_add(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_xonly_pubkey_tweak_add_check(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_keypair_create(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_keypair_pub(
    const secp256k1_context* ctx,
 ...
 *  In: keypair: pointer to a keypair (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_keypair_xonly_pub(
    const secp256k1_context* ctx,
    secp256k1_xonly_pubkey *pubkey,
    int *pk_parity,
    const secp256k1_keypair *keypair
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_keypair_xonly_tweak_add(
    const secp256k1_context* ctx,
    secp256k1_keypair *keypair,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
