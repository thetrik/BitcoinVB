 ...
 */
typedef int (SECP256_CC *secp256k1_nonce_function_hardened)(
 ...
 */
SECP256K1_API int SECP256_CC secp256k1_schnorrsig_sign(
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int SECP256_CC secp256k1_schnorrsig_verify(
    const secp256k1_context* ctx,
...
SECP256K1_API const secp256k1_nonce_function_hardened SECP256_CC secp256k1_nonce_function_bip340_get() {
