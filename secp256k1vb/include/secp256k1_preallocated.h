 ...
 */
SECP256K1_API size_t SECP256_CC secp256k1_context_preallocated_size(
    unsigned int flags
 ...
 */
SECP256K1_API secp256k1_context* SECP256_CC secp256k1_context_preallocated_create(
    void* prealloc,
    unsigned int flags
 ...
 */
SECP256K1_API size_t SECP256_CC secp256k1_context_preallocated_clone_size(
 ...
 *                     bytes, as detailed above (cannot be NULL)
 */
SECP256K1_API secp256k1_context* SECP256_CC secp256k1_context_preallocated_clone(
    const secp256k1_context* ctx,
    void* prealloc
 ...
 */
SECP256K1_API void SECP256_CC secp256k1_context_preallocated_destroy(
